...
import { IoAddCircleOutline, IoBedOutline, IoCamera, IoCaretDownOutline, IoFilm, IoHeartOutline, IoLocation, IoManOutline, IoResizeOutline, IoSquareOutline } from 'react-icons/io5'
    ...
    <div>
        ...
        <div className="heading">
            <div className="inputBox">
                    ...
                    <IoCaretDownOutline className='ion_icon select_custom_dropdown'/>
                    </div>
            </div>
            <p>
                6 propriétés trouvées
             </p>
            <BiCategory className='ion_icon'/>
        </div>
